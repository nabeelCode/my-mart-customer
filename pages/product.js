...
export default function ProductDetail() {
    return (
        <div className="grid gap-2 p-2 px-3">
            ...
            >
                ...
                <SwiperSlide className="w-auto">
                    <Image
                        ...
                        className="shadow rounded-lg"
                    />
                    <div className="z-10 absolute h-full w-full bg-red-400 top-0" />
                </SwiperSlide>
                <SwiperSlide className="w-auto">
                    <Image
                        alt="gallery"
            ...
            <div className="fixed bottom-1 shadow-normal flex justify-between bg-primary w-[96%] text-white p-2 rounded-md">
                <div>8</div>
                <div>Go to Cart</div>
                <div>&#8377;200</div>
            </div>
